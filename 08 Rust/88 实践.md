...
| ---- | ---- | ---- | ---- |
| 单一所有权 | T | &T | &mut T |
| 单线程多所有权 | Rc\<T\> | &Rc\<T\> | 无法可变 |
| 单线程多所有权 | Rc\<RefCell\<T\>\> | v.borrow() | v.borrow_mut() |
| 多线程多所有权 | Arc\<T\> | &Arc\<T\> | 无法可变 |
| 多线程多所有权 | Arc\<Mutex\<T\>\> | v.lock() | v.lock() |
| 多线程多所有权 | Arc\<RwLock\<T\>\> | v.read() | v.write() |
